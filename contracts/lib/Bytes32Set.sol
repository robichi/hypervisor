...
library Bytes32Set {
     ...
     */    
    function insert(Set storage self, bytes32 key, string memory errorMessage) internal {
     ...
     */    
    function remove(Set storage self, bytes32 key, string memory errorMessage) internal {
        require(exists(self, key), errorMessage);
